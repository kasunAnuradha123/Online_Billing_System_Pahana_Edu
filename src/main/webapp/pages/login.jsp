...
<body class="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-800 flex items-center justify-center  relative overflow-auto py-10">
    ...
    <div class="absolute top-40 right-32 text-white/10 animate-bounce" style="animation-delay: 1s;">
        <i class="fas fa-book-open text-3xl"></i>
    </div>
    <div class="absolute bottom-32 left-32 text-white/10 animate-bounce" style="animation-delay: 2s;">
    ...
    <div class="relative z-10 w-full max-w-md">
        ...
        <div class="text-center mb-8 animate-fade-in">
            <div class="inline-flex items-center justify-center w-20 h-20 bg-white/10 backdrop-blur-md rounded-full mb-4 border border-white/20">
                <i class="fas fa-book-reader text-3xl text-white"></i>
            </div>
            <h1 class="text-3xl font-bold text-white mb-2">Pahana Edu BookShop</h1>
            <p class="text-white/80 text-sm">Billing & Dashboard System</p>
        </div>

        <!-- Login Form -->
        <form action="LoginServlet" method="post" class="animate-slide-up">
            <div class="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 shadow-2xl">
                ...
                <div class="mb-6">
                    ...
                    <div class="relative">
                        <input 
                            ...
                            required
                        >
                        <div class="absolute inset-0 rounded-xl bg-gradient-to-r from-pink-400/20 to-purple-400/20 opacity-0 transition-opacity duration-300 pointer-events-none focus-within:opacity-100"></div>
                    </div>
                </div>
                ...
                <div class="flex items-center justify-between mb-6 text-sm">
                    <label class="flex items-center text-white/80 cursor-pointer hover:text-white transition-colors">
                        ...
                        <div class="relative">
                            <div class="w-4 h-4 bg-white/10 border border-white/30 rounded transition-all duration-200"></div>
                            <div class="absolute inset-0 w-4 h-4 bg-gradient-to-r from-pink-400 to-purple-400 rounded opacity-0 transition-opacity duration-200"></div>
                            <i class="fas fa-check absolute inset-0 w-4 h-4 text-white text-xs flex items-center justify-center opacity-0 transition-opacity duration-200"></i>
                        </div>
                        <span class="ml-2">Remember me</span>
                    </label>
                    <a href="#" class="text-pink-300 hover:text-pink-200 transition-colors duration-200 hover:underline">
                        Forgot password?
                    </a>
                </div>
                ...
                <div class="mt-6 text-center">
                    <p class="text-white/60 text-sm">
                        New to BookShop? 
                        <a href="#" class="text-pink-300 hover:text-pink-200 transition-colors duration-200 hover:underline font-medium">
        ...
        <div class="text-center mt-8 animate-fade-in">
            <p class="text-white/50 text-xs">
                © 2025 Pahana Edu BookShop. Secure Billing System.
            </p>
        </div>
    </div>
